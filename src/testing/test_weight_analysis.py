...
# Test imports (will fail without torch, but shows module structure is correct)
try:
...
try:
    ...
    # Check methods exist
    methods = [
        '_reset', '_classify_parameter', '_extract_block_idx',
        '_record_parameter', 'collect_data', 'get_results',
        'print_results', 'print_parameter_details'
    ]
    ...
    attrs = ['param_data', 'global_stats', '_hist_counts', '_data_range', '_weight_counts', '_name_to_idx', 'num_blocks']
    for attr in attrs:
