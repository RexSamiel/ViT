...
@register_model
def vit_gigantic_patch14_clip_378(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    """ViT-bigG model (ViT-G/14) from `Scaling Vision Transformers` - https://arxiv.org/abs/2106.04560
    Pretrained weights from CLIP image tower.
...
@register_model
def vit_base_patch32_siglip_256(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=32,
...
@register_model
def vit_large_patch16_siglip_512(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_so400m_patch16_siglip_384(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_so400m_patch16_siglip_512(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_giantopt_patch16_siglip_256(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_giantopt_patch16_siglip_384(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_base_patch32_siglip_gap_256(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=32,
...
@register_model
def vit_large_patch16_siglip_gap_512(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_so400m_patch16_siglip_gap_384(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_so400m_patch16_siglip_gap_512(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_giantopt_patch16_siglip_gap_256(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_giantopt_patch16_siglip_gap_384(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_dwee_patch16_reg1_gap_256(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_dpwee_patch16_reg1_gap_256(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_dlittle_patch16_reg1_gap_256(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    model_args = dict(
        patch_size=16,
...
@register_model
def vit_so150m2_patch16_reg1_gap_384(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    """SO150M v2 (shape optimized, but diff than paper def, optimized for GPU)"""
    model_args = dict(
...
@register_model
def vit_so150m2_patch16_reg1_gap_448(
    pretrained: bool = False, **kwargs
) -> VisionTransformer:
    """SO150M v2 (shape optimized, but diff than paper def, optimized for GPU)"""
    model_args = dict(
...
def beit3_base_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer(
        "beit3_base_patch16_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def beit3_large_patch16_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer(
        "beit3_large_patch16_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def beit3_giant_patch14_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer(
        "beit3_giant_patch14_224", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
...
def beit3_giant_patch14_336(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer(
        "beit3_giant_patch14_336", pretrained=pretrained, **dict(model_args, **kwargs)
    )
    return model
